...
user_invocable: true
# Least-privilege tool scope: triage is READ-ONLY. It reports; it never edits.
allowed-tools: Read, Grep, Glob, Bash(pytest*), Bash(ruff*), Bash(git status:*), Bash(git diff:*), Bash(git log:*)
---
